...
export default function Perfil() {
  ...
  return (
    <div className={styles.container}>
      ...
      <SideBarPerfil abrirSidebar={menuAberto} onEditar={alternarEdicao} onExcluir={deletar} onLogout={logout} />
      <div className={styles.profileWrapper}>
        ...
        {!editando ? (
          <div className={styles.infoContainer}>
            ...
            <p>
              <strong>Endereço:</strong> {user.endRua}, {user.endNum} - {user.endCompl}
            </p>
            <p>
              <strong>Bairro:</strong> {user.endBairro}
            </p>
            <p>
              <strong>Cidade:</strong> {user.endCidade} - {user.endUF}
            </p>
            <p>
              <strong>CEP:</strong> {user.endCEP}
            </p>
            <p>
          ...
          <div className={styles.editContainer}>
            <div className={styles.inputGroup}>
              <label>Nome:</label>
              <input type="text" name="nome" value={formData.nome || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Email:</label>
              <input type="email" name="email" value={formData.email || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Telefone:</label>
              <input type="text" name="telefone" value={formData.telefone || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Rua:</label>
              <input type="text" name="endRua" value={formData.endRua || ""} onChange={alterarCampo} />
            </div>
            ...
            <div className={styles.inputGroup}>
              <label>Bairro:</label>
              <input type="text" name="endBairro" value={formData.endBairro || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Cidade:</label>
              <input type="text" name="endCidade" value={formData.endCidade || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Estado (UF):</label>
              <input type="text" name="endUF" value={formData.endUF || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>CEP:</label>
              <input type="text" name="endCEP" value={formData.endCEP || ""} onChange={alterarCampo} />
            </div>

            <div className={styles.inputGroup}>
              <label>Tipo:</label>
              <input type="text" name="tipo" value={formData.tipo || ""} onChange={alterarCampo} />
            </div>
